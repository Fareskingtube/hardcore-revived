...
public class ModItems {
    ...
    public static final Item BUTCHER_KNIFE = registerItem("butcher_knife", new SwordItem(ModToolMaterials.BUTCHER_KNIFE_MATERIAL, new Item.Settings()
            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.BUTCHER_KNIFE_MATERIAL, 3, -1.8f))));
    // TODO: Add tooltip for how to get
    public static final Item BLOOD = registerItem("blood", new Item(new Item.Settings()));
